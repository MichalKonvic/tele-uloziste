...
const CodeGrabber = (
    ...
    return (
        ...
        >
            ...
            >
                <input id="0" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
                <input id="1" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
                <input id="2" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
                <input id="3" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
                <input id="4" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
                <input id="5" onKeyPress={(e) => valueCheck(e)} type="tel" disabled={isLoading} maxLength={1} autoCorrect='off' className='duration-300 w-12 h-12 border-2 text-center text-2xl font-bold rounded-xl outline-none appearance-none' />
            </div>
